...
public class CrewController {
    ...
    @GetMapping("/{id}")
    public CrewResponse getCrewById(@PathVariable Long id) {
        return crewService.getCrewById(id);
    }

    @PostMapping
    public CrewResponse createCrew(@Valid @RequestBody CrewRequest crewRequest) {
    ...
    public CrewResponse updateCrew(
            ...
            @Valid @RequestBody CrewRequest crewRequest) {
